...
export const VIDEO_API_ENDPOINT = 'https://compute.internal.soundmasque.com:7263';
export const INFERENCE_API_ENDPOINT = 'https://compute.internal.soundmasque.com:7263';
