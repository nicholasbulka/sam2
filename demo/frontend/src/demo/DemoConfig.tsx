...
export const VIDEO_API_ENDPOINT = "http://localhost"; //'http://compute.internal.soundmasque.com';
export const INFERENCE_API_ENDPOINT = "http://localhost"; //'http://compute.internal.soundmasque.com';
